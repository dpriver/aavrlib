...
/*
 * This library is a set of functionality for 7seg displays connected via SPI

 * This are the ones i have, and which i tested
 */
...
#if !defined(D7SEG_ZHS110561K) && !defined(D7SEG_FYQ5641BS)
    #define D7SEG_ZHS110561K
#endif
