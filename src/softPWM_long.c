...
#define SOFTPWM_L_DUTY_int       TIMER_COMPB_ISR(_SOFTPWM_L_TIMER)  
#define SOFTPWM_L_TOP_int        TIMER_COMPA_ISR(_SOFTPWM_L_TIMER)
#define SOFTPWM_L_TIMER          TIMER_TIMER(_SOFTPWM_L_TIMER)
#define SOFTPWM_L_PRESC(presc)   TIMER_PRESC(_SOFTPWM_L_TIMER, presc)
#define SOFTPWM_L_CURR_CNT()     TIMER_CURR_CNT(_SOFTPWM_L_TIMER)
